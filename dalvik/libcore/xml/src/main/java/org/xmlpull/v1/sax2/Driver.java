...
import org.kxml2.io.KXmlParser; /* FihtdcCode@20100422 JerryCheng for F0XE.B-599 begin */
...
public class Driver implements Locator, XMLReader, Attributes
{
    ...
    public void setProperty (String name, Object value)
        throws SAXNotRecognizedException, SAXNotSupportedException
    {
	/* FihtdcCode@20100422 JerryCheng for F0XE.B-599 begin */
        if( null != name && name.equals("enableMmsFlag") ){
            ((KXmlParser)pp).setMmsFlag(true);
            return;
        }else if( null != name && name.equals("disableMmsFlag") ){
            ((KXmlParser)pp).setMmsFlag(false);
            return;
        }
	/* FihtdcCode@20100422 JerryCheng for F0XE.B-599 end */
